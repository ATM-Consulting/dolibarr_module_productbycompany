...
/**
 * 	\defgroup   productbycompany     Module ProductByCompany
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/productbycompany/core/modules directory.
 *  \file       htdocs/productbycompany/core/modules/modProductByCompany.class.php
 *  \ingroup    productbycompany
 *  \brief      Description and activation file for module ProductByCompany
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module ProductByCompany
 */
class modProductByCompany extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'productbycompany';
		...
		$this->url_last_version = \productbycompany\TechATM::getLastModuleVersionUrl($this);
		...
		// for specific css file (eg: /productbycompany/css/productbycompany.css.php)
		...
		$this->module_parts = array(
			...
			'triggers' => 1,
			'css' => array(
				'/productbycompany/css/style.css'
			)
		);
		...
		$this->langfiles = array("productbycompany@productbycompany");

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(0=>array('PRODUCTBYCOMPANY_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		//                             1=>array('PRODUCTBYCOMPANY_MYNEWCONST2','chaine','myvalue','This is another constant to add',0, 'current', 1)
		// );
		$this->const = array();
        ...
        */
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=productbycompany',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'ProductByCompany top menu',
		//							'mainmenu'=>'productbycompany',
		//							'leftmenu'=>'productbycompany_left',			// This is the name of left menu for the next entries
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=productbycompany,fk_leftmenu=productbycompany_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'ProductByCompany left menu',
		//							'mainmenu'=>'productbycompany',
		//							'leftmenu'=>'productbycompany_left',			// Goes into left menu previously created by the mainmenu
		//							'url'=>'/productbycompany/pagelevel2.php',
		//							'langs'=>'productbycompany@productbycompany',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
...
/*
		$this->menu[$r]=array(
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuProductByCompany'),
			'mainmenu'=>'productbycompany',
			'leftmenu'=>'',
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=productbycompany',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuProductByCompany'),
			'mainmenu'=>'productbycompany',
			'leftmenu'=>'productbycompany_left',
			'url'=>'/productbycompany/list.php',
			'langs'=>'productbycompany@productbycompany',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'isModEnabled("productbycompany")',	// Define condition to show or hide menu entry. Use 'isModEnabled("missionorder")' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=productbycompany,fk_leftmenu=productbycompany_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuProductByCompanyCreate'),
			'mainmenu'=>'productbycompany',
			'leftmenu'=>'productbycompany_left_create',
			'url'=>'/productbycompany/card.php?action=create',
			'langs'=>'productbycompany@productbycompany',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=productbycompany,fk_leftmenu=productbycompany_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuProductByCompanyList'),
			'mainmenu'=>'productbycompany',
			'leftmenu'=>'productbycompany_left_list',
			'url'=>'/productbycompany/list.php',
			'langs'=>'productbycompany@productbycompany',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->productbycompany->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
*/
	...
	public function init($options = '')
	{
		...
		$result=$this->_load_tables('/productbycompany/sql/');
